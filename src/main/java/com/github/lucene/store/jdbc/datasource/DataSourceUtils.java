...
public abstract class DataSourceUtils {
     ...
     */
    public static int getColumnIndexFromColumnName(final ResultSetMetaData metaData, final String columnName)
            throws SQLException {
        for (int i = 1; i <= metaData.getColumnCount(); i++) {
            final String tmpName = metaData.getColumnLabel(i);
    ...
    public static Connection getTargetConnection(final Connection conn) {
